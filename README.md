...
> *Within the reducers folder is the movieReducers file. We have the state already setup here with some initial data. Let's connect that state to our component.*
